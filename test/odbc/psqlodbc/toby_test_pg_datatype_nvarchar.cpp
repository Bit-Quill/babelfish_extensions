...
string InitializeInsertString_nvarchar(const vector<vector<string>> &inserted_values) {
...
TEST_F(PSQL_DataTypes_Nvarchar, ColAttributes) {
...
TEST_F(PSQL_DataTypes_Nvarchar, Insertion_Success) {
  ...
  string insert_string = InitializeInsertString_nvarchar(inserted_values);
